    ...
    try:
        ...
        for msg in reversed(res_messages):
            if isinstance(msg, AIMessage) and msg.content:
                ...
                break
        tool_names = list(set(
            msg.name if isinstance(msg, (ToolMessage, FunctionMessage)) and msg.name else "Unknown Tool"
            for msg in res_messages if isinstance(msg, (ToolMessage, FunctionMessage))
        ))
